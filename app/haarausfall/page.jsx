...
const PRODUCT_URL = '/duschkopf-haarausfall';

export default function Page() {
  return (
    <>
      <div className="anzeige-bar">
        <strong>Duschkopf bei Haarausfall</strong> · Vergleich &amp; Kaufberatung 2026
      </div>
      ...
      <div className="breadcrumb">
        <div className="wrap">
          ...
          <span>Duschkopf bei Haarausfall</span>
        </div>
      </div>
      ...
      <div className="shell">
        <main className="shell-main">
          ...
          <section style={{ padding: '24px 0 0' }}>
            <div className="wrap narrow">
              <p style={{ fontSize: '18px', color: 'var(--ink)', lineHeight: 1.7 }}>
                Wer dünner werdendes Haar oder eine gereizte Kopfhaut bemerkt, schaut meist auf Shampoo, Ernährung und
                Pflege. Das Duschwasser selbst bleibt dabei oft außen vor. Dabei ist hartes, gechlortes Wasser ein
                bekannter Stressfaktor: Chlor und Kalk trocknen Haar und Kopfhaut aus, das Haar wirkt strohiger, bricht
              ...
              <p>
                ...
                Labortests. Für empfindliches Haar zählt für mich vor allem: Wie gut holt der Filter Chlor und Kalk aus
                dem Wasser, wie fair sind die Folgekosten und wie unkompliziert ist der Alltag.
              </p>
            ...
            <div className="wrap narrow">
              <div className="verdict">
                ...
                <div className="vbars">
                  ...
                  <div className="vbar">
                    <div className="vbar-top">
                      <span>Schonung für Haar &amp; Kopfhaut</span>
                      <b>9,4/10</b>
                    </div>
                    <div className="vtrack">
          ...
          <section style={{ paddingTop: '8px' }}>
            <div className="wrap narrow">
              <h2 style={{ marginBottom: '10px' }}>Die Top 3 für schonenderes Duschwasser</h2>
              <p>Bevor es zu den ausführlichen Einzelbewertungen geht, hier die drei besten Modelle in Kürze:</p>
              <ol className="top3">
                <li>
                  <b><a href={PRODUCT_URL}>Caldris Flow Plus</a></b> (9,6/10), ideal bei empfindlichem Haar und hartem
          ...
          <section style={{ background: '#eef3f2' }}>
            <div className="wrap">
              <div className="section-tag">Warum's bei empfindlichem Haar mein Favorit ist</div>
              ...
              <div className="trust">
                ...
                <div className="tcard">
                  ...
                  <h4>Schonender zu Haar &amp; Kopfhaut</h4>
                  <p>Weicheres Wasser kann Haarbruch durch aggressives Duschwasser verringern.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
          ...
          <section>
            <div className="wrap narrow faq">
              ...
              <h2 style={{ marginBottom: '22px' }}>Haarausfall &amp; Duschwasser: was oft gefragt wird</h2>

              <details open>
                <summary>Kann ein Filterduschkopf Haarausfall stoppen?</summary>
                <div className="ans">
                  Nein. Ein Filterduschkopf behandelt keinen Haarausfall und ist kein Medizinprodukt. Erblich oder
                  hormonell bedingter Haarausfall gehört ärztlich abgeklärt. Ein Filter kann das Duschwasser schonender
                  machen und Chlor sowie Kalk reduzieren, mehr verspreche ich hier bewusst nicht.
                </div>
              </details>
              <details>
                <summary>Warum können hartes und gechlortes Wasser Haar und Kopfhaut belasten?</summary>
                <div className="ans">
                  Chlor und Kalk entziehen Haar und Kopfhaut Feuchtigkeit. Das Haar kann dadurch trockener, strohiger und
                  brüchiger wirken, die Kopfhaut spannt schneller. Das ist kein Haarausfall, aber ein Komfort- und
                  Zustandsthema, das viele bei hartem Wasser kennen.
                </div>
              </details>
              <details>
              ...
              <details>
                <summary>Ersetzt das den Gang zur Ärztin?</summary>
                <div className="ans">
                  Nein. Wenn Haar spürbar ausfällt oder sich die Kopfhaut verändert, ist die Haus- oder Hautärztin die
                  richtige Adresse. Ein Filterduschkopf ist eine Alltagsmaßnahme für schonenderes Wasser, keine
          ...
          <section style={{ paddingTop: 0 }} id="transparenz">
            <div className="wrap narrow">
              <div className="disclosure">
                ...
                <p>
                  <b>Kein Gesundheitsversprechen:</b> Der Caldris Flow Plus ist ein Filterduschkopf, kein Medizinprodukt.
                  Er behandelt, heilt oder stoppt keinen Haarausfall und ersetzt keine ärztliche Beratung oder
                  Behandlung. Aussagen zu Haar und Kopfhaut beziehen sich auf schonenderes, gefiltertes Duschwasser, nicht
                  auf eine medizinische Wirkung.
                </p>
                <p>
