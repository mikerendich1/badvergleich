...
export const metadata = {
  title: 'Duschkopf gegen Kalk: welcher Filter Kalk und Rückstände im Duschwasser reduziert | BadVergleich',
  description:
    'Kalkbelag auf Duschkopf, Glas und Haut durch hartes Wasser? Wir vergleichen 5 Filterduschköpfe (Caldris, Hello Klean, Dupor, Sanquell, Doyoo) nach Filterleistung, Preis und Folgekosten. Ehrlich statt übertrieben.',
};

// Eigener Redirect für diese Landingpage (siehe next.config.mjs) → separate Klick-Zuordnung.
const PRODUCT_URL = '/duschkopf-kalk';

export default function Page() {
  return (
    <>
      <div className="anzeige-bar">
        <strong>Duschkopf gegen Kalkablagerungen</strong> · Vergleich &amp; Kaufberatung 2026
      </div>
      ...
      <div className="breadcrumb">
        <div className="wrap">
          ...
          <span>Duschkopf gegen Kalkablagerungen</span>
        </div>
      </div>

      <div className="shell">
        <main className="shell-main">
          <Hero title="Duschkopf gegen Kalk: welcher Filter Kalk und Rückstände im Duschwasser reduziert" />

          {/* INTRO (zielgruppenspezifisch: Kalkablagerungen) */}
          <section style={{ padding: '24px 0 0' }}>
            <div className="wrap narrow">
              <p style={{ fontSize: '18px', color: 'var(--ink)', lineHeight: 1.7 }}>
                Weiße Ränder am Duschkopf, matte Flecken auf Glas und Armaturen, ein rauer Belag auf der Haut: Bei hartem
                Wasser sorgt der hohe Kalkgehalt für Ablagerungen und Rückstände. Ein Filterduschkopf setzt direkt am
                Duschwasser an und reduziert Kalk und Rückstände, bevor sie sich absetzen.
              </p>

              <p className="honest-note">
                <b>Ehrlich vorab:</b> Ein Filterduschkopf ist kein Wasserenthärter für die ganze Wohnung und entfernt
                nicht jede Kalkablagerung. Er reduziert Kalk und Rückstände im Duschwasser, was weniger Belag,
                weicheres Hautgefühl und geschmeidigeres Haar bedeuten kann. Bei sehr hartem Wasser im ganzen Haushalt
                bleibt eine zentrale Enthärtungsanlage die größere Lösung.
              </p>
              ...
              <p>
                ...
                Labortests. Beim Thema Kalk zählt für mich vor allem: Wie gut holt der Filter Kalk und Rückstände aus dem
          ...
          <section style={{ paddingTop: '8px' }}>
            <div className="wrap narrow">
              <h2 style={{ marginBottom: '10px' }}>Die Top 3 für weniger Kalk im Duschwasser</h2>
              <p>Bevor es zu den ausführlichen Einzelbewertungen geht, hier die drei besten Modelle in Kürze:</p>
              <ol className="top3">
                <li>
                  <b><a href={PRODUCT_URL}>Caldris Flow Plus</a></b> (9,6/10), ideal bei hartem Wasser und Kalkbelag:
          ...
          {/* GEMEINSAMER VERGLEICH (5 Modelle + Tabelle) mit Kalk-Hinweisen */}
          <ProductComparison
            productUrl={PRODUCT_URL}
            audienceNotes={{
              cd: 'Die 5-Stufen-Aktivkohle reduziert Chlor, Kalk und feine Rückstände im Duschwasser, spürbar vor allem in Regionen mit sehr hartem Wasser. Das kann weniger Belag sowie weichere Haut und weicheres Haar bedeuten, ganz ohne Abo.',
              hk: 'Der 2-Stufen-Filter ist stärker auf Chlor als auf Kalk ausgelegt. Solide, aber durch das Refill-Abo wird der Dauerbetrieb teurer.',
              dp: '4-Stufen-Filterung reduziert Chlor und Kalk zuverlässig, gut gegen Rückstände im Wasser, ganz ohne Abo. Nur Marken- und Bildwelt wirken weniger hochwertig.',
              sq: 'Die Sicherheitsmembran zielt auf Keime und Legionellen, nicht primär auf Kalk. Für den reinen Kalk-Fokus überdimensioniert und mit teuren Filtern verbunden.',
              dy: 'Wirbt mit Beauty-Extras, doch die Angaben zu Kalk- und Filterleistung sowie den Folgekosten bleiben unklar, und der Service ist ein Vertrauensthema.',
            }}
          />
          ...
          <section style={{ background: '#eef3f2' }}>
            <div className="wrap">
              <div className="section-tag">Warum's gegen Kalk mein Favorit ist</div>
              <h2 style={{ marginBottom: '24px' }}>Weniger Kalk. Kein Abo. Ehrlich statt übertrieben.</h2>
              <div className="trust">
                <div className="tcard">
                  <div className="ic">
                    <svg
                  ...
                  <h4>Reduziert Chlor &amp; Kalk</h4>
                  <p>Das 5-Stufen-Aktivkohlesystem holt Restchlor, Kalk und feine Rückstände aus dem Wasser.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
                      ...
                      style={{ display: 'block', margin: '0 auto' }}
                    >
                      <path d="M7 21h10M12 21v-6M8 3h8l-1 8H9z" />
                      <path d="M9.5 11c0 1.5 1 2 2.5 2s2.5-.5 2.5-2" />
                    </svg>
                  </div>
                  <h4>Weniger Belag &amp; Rückstände</h4>
                  <p>Weicheres Duschwasser kann Kalkbelag auf Haut, Haar und Duschkopf mindern.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
          ...
          <section>
            <div className="wrap narrow faq">
              ...
              <h2 style={{ marginBottom: '22px' }}>Kalk &amp; Duschwasser: was oft gefragt wird</h2>

              <details open>
                <summary>Entfernt ein Filterduschkopf alle Kalkablagerungen?</summary>
                <div className="ans">
                  Nein, das wäre zu viel versprochen. Ein Filterduschkopf ist kein zentraler Wasserenthärter. Er
                  reduziert Kalk und Rückstände im Duschwasser, was weniger Belag und ein weicheres Wassergefühl bedeuten
                  kann. Vorhandene Ablagerungen musst du weiterhin normal reinigen.
                </div>
              </details>
              <details>
                <summary>Warum verursacht hartes Wasser Kalkablagerungen?</summary>
                <div className="ans">
                  Hartes Wasser enthält viel Calcium und Magnesium. Trocknet es ab, bleiben diese Mineralien als weißer
                  Kalkbelag auf Duschkopf, Glas, Armaturen und teils auf der Haut zurück.
                </div>
              </details>
              <details>
              ...
              <details>
                <summary>Ersetzt das eine zentrale Enthärtungsanlage?</summary>
                <div className="ans">
          ...
          <section style={{ paddingTop: 0 }} id="transparenz">
            <div className="wrap narrow">
              <div className="disclosure">
                ...
                <p>
                  Ein Filterduschkopf reduziert Kalk und Rückstände im Duschwasser, ist aber <b>kein zentraler
