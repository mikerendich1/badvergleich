...
export const metadata = {
  title: 'Duschkopf gegen Chlorwasser: welcher Filter Chlor beim Duschen am besten reduziert | BadVergleich',
  description:
    'Chlorgeruch, trockene Haut und gereizte Augen durch gechlortes Leitungswasser? Wir vergleichen 5 Filterduschköpfe (Caldris, Hello Klean, Dupor, Sanquell, Doyoo). Aktivkohle reduziert Chlor zuverlässig. Ehrlich, ohne Wunderversprechen.',
};

// Eigener Redirect für diese Landingpage (siehe next.config.mjs) → separate Klick-Zuordnung.
const PRODUCT_URL = '/duschkopf-chlor';

export default function Page() {
  return (
    <>
      <div className="anzeige-bar">
        <strong>Duschkopf gegen Chlorwasser</strong> · Vergleich &amp; Kaufberatung 2026
      </div>
      ...
      <div className="breadcrumb">
        <div className="wrap">
          ...
          <span>Duschkopf gegen Chlorwasser</span>
        </div>
      </div>

      <div className="shell">
        <main className="shell-main">
          <Hero title="Duschkopf gegen Chlorwasser: welcher Filter Chlor beim Duschen am besten reduziert" />

          {/* INTRO (zielgruppenspezifisch: Chlorwasser) */}
          <section style={{ padding: '24px 0 0' }}>
            <div className="wrap narrow">
              <p style={{ fontSize: '18px', color: 'var(--ink)', lineHeight: 1.7 }}>
                Ein leichter Chlorgeruch beim Duschen, danach trockene, spannende Haut und manchmal gereizte Augen: Dahinter
                steckt oft das Chlor, mit dem Leitungswasser desinfiziert wird. Warmes Duschwasser dampft aus, und der
                Chlorgeruch fällt besonders auf. Genau hier ist ein Aktivkohle-Filterduschkopf in seinem Element, denn
                Chlor zu binden ist die Kernaufgabe von Aktivkohle.
              </p>

              <p className="honest-note">
                <b>Ehrlich vorab:</b> Ein Filterduschkopf reduziert Chlor und Rückstände im Duschwasser, das ist die
                Stärke eines Aktivkohlefilters. Er ist aber kein Medizinprodukt und ersetzt keine Trinkwasseraufbereitung.
                Wunder verspreche ich nicht, ein spürbar angenehmeres, chlorärmeres Duschgefühl ist aber realistisch.
              </p>
              ...
              <p>
                ...
                Labortests. Beim Thema Chlor zählt für mich vor allem: Wie gut und wie zuverlässig bindet der Filter
                Chlor, wie fair sind die Folgekosten und wie unkompliziert ist der Alltag.
              </p>
            ...
            <div className="wrap narrow">
              <div className="verdict">
                ...
                <div className="vbars">
                  ...
                  <div className="vbar">
                    <div className="vbar-top">
                      <span>Filterleistung gesamt</span>
                      <b>9,4/10</b>
                    </div>
                    <div className="vtrack">
          ...
          <section style={{ paddingTop: '8px' }}>
            <div className="wrap narrow">
              <h2 style={{ marginBottom: '10px' }}>Die Top 3 gegen Chlor im Duschwasser</h2>
              <p>Bevor es zu den ausführlichen Einzelbewertungen geht, hier die drei besten Modelle in Kürze:</p>
              <ol className="top3">
                <li>
                  <b><a href={PRODUCT_URL}>Caldris Flow Plus</a></b> (9,6/10), ideal gegen Chlorgeruch und gechlortes
                  Wasser: starke Aktivkohle-Filterung, faire Folgekosten, kein Abo.
                </li>
                <li>
          ...
          {/* GEMEINSAMER VERGLEICH (5 Modelle + Tabelle) mit Chlor-Hinweisen */}
          <ProductComparison
            productUrl={PRODUCT_URL}
            audienceNotes={{
              cd: 'Die 5-Stufen-Aktivkohle ist genau auf Chlor ausgelegt: Sie bindet Restchlor und Chlornebenprodukte zuverlässig, dazu Kalk und feine Rückstände. Das nimmt den Chlorgeruch und macht das Duschwasser spürbar angenehmer, ganz ohne Abo.',
              hk: 'Der 2-Stufen-Filter reduziert Chlor solide, mit klarem Beauty-Fokus. Aber das Refill-Abo macht den Dauerbetrieb gegen Chlor teurer.',
              dp: '4-Stufen-Filterung mit Aktivkohle senkt Chlor zuverlässig, dazu Kalk, ganz ohne Abo. Nur Marken- und Bildwelt wirken weniger hochwertig.',
              sq: 'Die Hohlfasermembran zielt auf Keime und Partikel, nicht in erster Linie auf Chlor. Gegen reinen Chlorgeruch ist das die falsche Baustelle und zudem teuer.',
              dy: 'Wirbt mit Beauty-Extras, doch konkrete Angaben zur Chlor-Filterleistung und zu den Folgekosten bleiben unklar, und der Service ist ein Vertrauensthema.',
            }}
          />
          ...
          <section style={{ background: '#eef3f2' }}>
            <div className="wrap">
              <div className="section-tag">Warum's gegen Chlor mein Favorit ist</div>
              <h2 style={{ marginBottom: '24px' }}>Weniger Chlor. Kein Abo. Ehrlich statt Wunderversprechen.</h2>
              <div className="trust">
                <div className="tcard">
                  <div className="ic">
                    <svg
                  ...
                  <h4>Reduziert Chlor zuverlässig</h4>
                  <p>Chlor zu binden ist die Kernaufgabe der 5-stufigen Aktivkohle im Caldris.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
                  ...
                  <h4>Weniger Chlorgeruch &amp; Reizung</h4>
                  <p>Chlorärmeres Duschwasser kann Haut und Augen weniger reizen und riecht neutraler.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
          ...
          <section>
            <div className="wrap narrow faq">
              ...
              <h2 style={{ marginBottom: '22px' }}>Chlor im Duschwasser: was oft gefragt wird</h2>

              <details open>
                <summary>Reduziert ein Filterduschkopf wirklich Chlor?</summary>
                <div className="ans">
                  Ja. Aktivkohle bindet Chlor, das ist eine ihrer klassischen Aufgaben und in der Praxis gut belegt. Ein
                  guter Aktivkohle-Filterduschkopf senkt den Chlorgehalt im Duschwasser spürbar. Ein Medizinprodukt oder
                  eine Trinkwasseraufbereitung ist er deshalb aber nicht.
                </div>
              </details>
              <details>
                <summary>Woran merke ich zu viel Chlor im Duschwasser?</summary>
                <div className="ans">
                  Typisch sind ein leichter Chlorgeruch (vor allem bei warmem Wasser), trockene, spannende Haut nach dem
                  Duschen und manchmal gereizte Augen. Wie stark das ausfällt, hängt von der Chlorung deines lokalen
                  Wassers ab.
                </div>
              </details>
              <details>
              ...
              <details>
                <summary>Ersetzt das eine Trinkwasseraufbereitung?</summary>
                <div className="ans">
                  Nein. Es geht ums Duschwasser, nicht ums Trinkwasser. Für die Trinkwasseraufbereitung sind andere
                  Systeme zuständig. Ein Filterduschkopf verbessert gezielt das Wasser, mit dem du dich duschst.
                </div>
              </details>
              <details>
          ...
          <section style={{ paddingTop: 0 }} id="transparenz">
            <div className="wrap narrow">
              <div className="disclosure">
                ...
                <p>
                  Ein Filterduschkopf reduziert Chlor und Rückstände im Duschwasser, ist aber <b>kein Medizinprodukt</b>
                  {' '}und keine Trinkwasseraufbereitung. Die Wirkung hängt von der Chlorung und Qualität deines lokalen
                  Wassers ab.
                </p>
                <p>
