...
export const metadata = {
  title: 'Duschkopf bei trockener Haut: welcher Filter die Haut am besten schont | BadVergleich',
  description:
    'Hartes, gechlortes Wasser trocknet die Haut aus und sorgt für Spannungsgefühl nach dem Duschen. Wir vergleichen 5 Filterduschköpfe (Caldris, Hello Klean, Dupor, Sanquell, Doyoo). Ehrlich, ohne Heilversprechen.',
};

// Eigener Redirect für diese Landingpage (siehe next.config.mjs) → separate Klick-Zuordnung.
const PRODUCT_URL = '/duschkopf-trockene-haut';

export default function Page() {
  return (
    <>
      <div className="anzeige-bar">
        <strong>Duschkopf bei trockener Haut</strong> · Vergleich &amp; Kaufberatung 2026
      </div>
      ...
      <div className="breadcrumb">
        <div className="wrap">
          ...
          <span>Duschkopf bei trockener Haut</span>
        </div>
      </div>

      <div className="shell">
        <main className="shell-main">
          <Hero title="Duschkopf bei trockener Haut: welcher Filter die Haut am besten schont" />

          {/* INTRO (zielgruppenspezifisch: trockene Haut) */}
          <section style={{ padding: '24px 0 0' }}>
            <div className="wrap narrow">
              <p style={{ fontSize: '18px', color: 'var(--ink)', lineHeight: 1.7 }}>
                Wer zu trockener Haut neigt, kennt das Spannungsgefühl direkt nach dem Duschen: Die Haut fühlt sich rau
                an, spannt oder juckt, statt sich frisch anzufühlen. Oft liegt das nicht an der Pflege, sondern am
                Wasser. Hartes, gechlortes Wasser entzieht der Haut Feuchtigkeit und greift ihren natürlichen
                Schutzfilm an.
              </p>

              <p className="honest-note">
                <b>Ehrlich vorab:</b> Ein Filterduschkopf ist kein Medikament und behandelt keine Hauterkrankungen wie
                Neurodermitis oder Schuppenflechte. Er kann das Wasser schonender machen und Chlor sowie Kalk reduzieren,
                was trockene, spannende Haut entlasten kann. Bei anhaltenden Hautproblemen ist deine Haus- oder
                Hautärztin die richtige Adresse.
              </p>
              ...
              <p>
                ...
                Labortests. Für trockene Haut zählt für mich vor allem: Wie gut holt der Filter Chlor und Kalk aus dem
            ...
            <div className="wrap narrow">
              <div className="verdict">
                ...
                <div className="vbars">
                  ...
                  <div className="vbar">
                    <div className="vbar-top">
                      <span>Schonung für die Haut</span>
                      <b>9,4/10</b>
                    </div>
                    <div className="vtrack">
          ...
          <section style={{ paddingTop: '8px' }}>
            <div className="wrap narrow">
              <h2 style={{ marginBottom: '10px' }}>Die Top 3 für hautschonendes Duschwasser</h2>
              <p>Bevor es zu den ausführlichen Einzelbewertungen geht, hier die drei besten Modelle in Kürze:</p>
              <ol className="top3">
                <li>
                  <b><a href={PRODUCT_URL}>Caldris Flow Plus</a></b> (9,6/10), ideal bei trockener Haut und hartem
                  Wasser: starke Filterung, faire Folgekosten, kein Abo.
                </li>
                <li>
          ...
          {/* GEMEINSAMER VERGLEICH (5 Modelle + Tabelle) mit Haut-Hinweisen */}
          <ProductComparison
            productUrl={PRODUCT_URL}
            audienceNotes={{
              cd: 'Die 5-Stufen-Aktivkohle nimmt Chlor und Kalk aus dem Wasser, also genau die Stoffe, die der Haut Feuchtigkeit entziehen und für das Spannungsgefühl nach dem Duschen sorgen. Bei trockener Haut und hartem Wasser der spürbarste Unterschied, ganz ohne Abo.',
              hk: 'Der Beauty-Fokus zielt bewusst auf Haut und Haar, der 2-Stufen-Filter reduziert Chlor. Für empfindliche Haut solide, aber durch das Refill-Abo wird der dauerhafte Einsatz spürbar teurer.',
              dp: '4-Stufen-Filterung senkt Chlor und Kalk zuverlässig, das entlastet trockene Haut, ganz ohne Abo. Nur Marken- und Bildwelt wirken weniger hochwertig.',
              sq: 'Die Sicherheitsmembran zielt auf Keime und Legionellen, nicht auf weiches, hautfreundliches Wasser. Für den Hautkomfort im Alltag überdimensioniert und mit teuren Filtern verbunden.',
              dy: 'Wirbt mit Beauty-Extras wie Peeling und Bürste, doch Filterwechsel und Folgekosten für dauerhaft hautschonendes Wasser bleiben unklar, und der Service ist ein Vertrauensthema.',
            }}
          />
          ...
          <section style={{ background: '#eef3f2' }}>
            <div className="wrap">
              <div className="section-tag">Warum's bei trockener Haut mein Favorit ist</div>
              <h2 style={{ marginBottom: '24px' }}>Schonenderes Wasser. Kein Abo. Ehrlich statt Heilversprechen.</h2>
              <div className="trust">
                <div className="tcard">
                  <div className="ic">
                    <svg
                  ...
                  <h4>Weniger Chlor &amp; Kalk</h4>
                  <p>Das 5-Stufen-Aktivkohlesystem reduziert Restchlor und Rückstände im Duschwasser.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
                  ...
                  <h4>Schonender zur Haut</h4>
                  <p>Weicheres Wasser kann trockene, spannende Haut nach dem Duschen entlasten.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
          ...
          <section>
            <div className="wrap narrow faq">
              ...
              <h2 style={{ marginBottom: '22px' }}>Trockene Haut &amp; Duschwasser: was oft gefragt wird</h2>

              <details open>
                <summary>Kann ein Filterduschkopf trockene Haut heilen?</summary>
                <div className="ans">
                  Nein. Ein Filterduschkopf ist kein Medizinprodukt und behandelt keine Hauterkrankungen. Er kann das
                  Duschwasser schonender machen und Chlor sowie Kalk reduzieren, die trockene Haut zusätzlich belasten.
                  Bei krankhaft trockener oder gereizter Haut gehört die Ursache ärztlich abgeklärt.
                </div>
              </details>
              <details>
                <summary>Warum trocknet hartes, gechlortes Wasser die Haut aus?</summary>
                <div className="ans">
                  Chlor und Kalk greifen den natürlichen Schutzfilm der Haut an und entziehen ihr Feuchtigkeit. Die Haut
                  spannt dann schneller, fühlt sich rau an und juckt manchmal, besonders nach heißem Duschen in Regionen
                  mit hartem Wasser.
                </div>
              </details>
              <details>
              ...
              <details>
                <summary>Ersetzt das meine Hautpflege oder den Arztbesuch?</summary>
                <div className="ans">
                  Nein. Creme und Pflege bleiben wichtig, und bei anhaltenden Hautproblemen ist die Haus- oder
                  Hautärztin die richtige Adresse. Ein Filterduschkopf ist eine Alltagsmaßnahme für schonenderes Wasser,
              ...
              <div className="author" style={{ alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '14px', margin: '8px 0 0' }}>
                    ...
                    Bewertungen, Community-Berichte und Herstellerdaten aus, ehrlich und ohne medizinische Versprechen.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section style={{ paddingTop: 0 }} id="transparenz">
            <div className="wrap narrow">
              <div className="disclosure">
                ...
                <p>
                  <b>Kein Gesundheitsversprechen:</b> Der Caldris Flow Plus ist ein Filterduschkopf, kein
                  Medizinprodukt. Er behandelt oder heilt keine Hauterkrankungen und ersetzt keine ärztliche Beratung
                  oder Behandlung. Aussagen zur Haut beziehen sich auf schonenderes, gefiltertes Duschwasser, nicht auf
                  eine medizinische Wirkung.
                </p>
                <p>
