...
export const metadata = {
  title: 'Duschkopf bei sprödem Haar: welcher Filter für mehr Glanz und Geschmeidigkeit sorgt | BadVergleich',
  description:
    'Sprödes, stumpfes Haar durch hartes, gechlortes Wasser? Wir vergleichen 5 Filterduschköpfe (Caldris, Hello Klean, Dupor, Sanquell, Doyoo) nach Filterleistung, Preis und Folgekosten. Ehrlich, ohne Wunderversprechen.',
};

// Eigener Redirect für diese Landingpage (siehe next.config.mjs) → separate Klick-Zuordnung.
const PRODUCT_URL = '/duschkopf-glanz';

export default function Page() {
  return (
    <>
      <div className="anzeige-bar">
        <strong>Duschkopf für glänzendes Haar</strong> · Vergleich &amp; Kaufberatung 2026
      </div>
      ...
      <div className="breadcrumb">
        <div className="wrap">
          ...
          <span>Duschkopf für glänzendes Haar</span>
        </div>
      </div>

      <div className="shell">
        <main className="shell-main">
          <Hero title="Duschkopf bei sprödem Haar: welcher Filter für mehr Glanz und Geschmeidigkeit sorgt" />

          {/* INTRO (zielgruppenspezifisch: sprödes/glänzendes Haar) */}
          <section style={{ padding: '24px 0 0' }}>
            <div className="wrap narrow">
              <p style={{ fontSize: '18px', color: 'var(--ink)', lineHeight: 1.7 }}>
                Sprödes, stumpfes Haar, das sich rau anfühlt und kaum glänzt, liegt oft nicht an der falschen Pflege,
                sondern am Wasser. Hartes, gechlortes Wasser lagert sich aufs Haar, raut die Oberfläche auf und lässt es
                matt und strohig wirken, statt geschmeidig und glänzend.
              </p>

              <p className="honest-note">
                <b>Ehrlich vorab:</b> Glanz hängt von vielen Faktoren ab, von Pflege über Ernährung bis zur
                Haarstruktur. Ein Filterduschkopf zaubert keine neue Haarpracht, aber er reduziert Chlor und Kalk, die
                Haar stumpf und spröde wirken lassen. Für ein weicheres, glänzenderes Haargefühl kann das einen
                Unterschied machen.
              </p>
              ...
              <p>
                ...
                Labortests. Für geschmeidiges, glänzendes Haar zählt für mich vor allem: Wie gut holt der Filter Chlor
                und Kalk aus dem Wasser, wie fair sind die Folgekosten und wie unkompliziert ist der Alltag.
              </p>
            ...
            <div className="wrap narrow">
              <div className="verdict">
                ...
                <div className="vbars">
                  ...
                  <div className="vbar">
                    <div className="vbar-top">
                      <span>Geschmeidigkeit &amp; Glanz</span>
                      <b>9,4/10</b>
                    </div>
                    <div className="vtrack">
          ...
          <section style={{ paddingTop: '8px' }}>
            <div className="wrap narrow">
              <h2 style={{ marginBottom: '10px' }}>Die Top 3 für geschmeidigeres, glänzenderes Haar</h2>
              <p>Bevor es zu den ausführlichen Einzelbewertungen geht, hier die drei besten Modelle in Kürze:</p>
              <ol className="top3">
                <li>
                  <b><a href={PRODUCT_URL}>Caldris Flow Plus</a></b> (9,6/10), ideal bei sprödem Haar und hartem Wasser:
                  starke Filterung, faire Folgekosten, kein Abo.
                </li>
                <li>
          ...
          {/* GEMEINSAMER VERGLEICH (5 Modelle + Tabelle) mit Haar-Glanz-Hinweisen */}
          <ProductComparison
            productUrl={PRODUCT_URL}
            audienceNotes={{
              cd: 'Die 5-Stufen-Aktivkohle holt Chlor und Kalk aus dem Wasser, also genau die Stoffe, die Haar stumpf, spröde und rau wirken lassen. Gefiltertes Wasser kann das Haar geschmeidiger anfühlen und den Glanz zurückbringen, ganz ohne Abo.',
              hk: 'Der Beauty-Fokus zielt bewusst auf glänzendes Haar, der 2-Stufen-Filter reduziert Chlor. Für den Glanz solide, aber durch das Refill-Abo wird der dauerhafte Einsatz spürbar teurer.',
              dp: '4-Stufen-Filterung senkt Chlor und Kalk zuverlässig, das kommt Haargefühl und Glanz zugute, ganz ohne Abo. Nur Marken- und Bildwelt wirken weniger hochwertig.',
              sq: 'Die Sicherheitsmembran zielt auf Keime und Legionellen, nicht auf geschmeidiges, glänzendes Haar. Für den Alltag mit Fokus auf Haarglanz überdimensioniert und mit teuren Filtern verbunden.',
              dy: 'Wirbt mit Beauty-Extras wie Peeling und Bürste, doch Filterwechsel und Folgekosten für dauerhaft geschmeidiges Haar bleiben unklar, und der Service ist ein Vertrauensthema.',
            }}
          />
          ...
          <section style={{ background: '#eef3f2' }}>
            <div className="wrap">
              <div className="section-tag">Warum's für glänzendes Haar mein Favorit ist</div>
              <h2 style={{ marginBottom: '24px' }}>Schonenderes Wasser. Kein Abo. Ehrlich statt Wunderversprechen.</h2>
              <div className="trust">
                <div className="tcard">
                  <div className="ic">
                    <svg
                ...
                <div className="tcard">
                  ...
                  <h4>Mehr Geschmeidigkeit &amp; Glanz</h4>
                  <p>Weicheres Wasser kann sprödes Haar geschmeidiger und glänzender wirken lassen.</p>
                </div>
                <div className="tcard">
                  <div className="ic">
                    <svg
          ...
          <section>
            <div className="wrap narrow faq">
              ...
              <h2 style={{ marginBottom: '22px' }}>Sprödes Haar &amp; Duschwasser: was oft gefragt wird</h2>

              <details open>
                <summary>Macht ein Filterduschkopf mein Haar automatisch glänzend?</summary>
                <div className="ans">
                  Kein Wunderversprechen von mir: Glanz hängt von Pflege, Ernährung und Haarstruktur ab. Ein Filter kann
                  Chlor und Kalk reduzieren, die Haar stumpf und spröde wirken lassen. Viele berichten dann von
                  weicherem, glänzenderem Haargefühl, garantieren lässt sich das aber nicht.
                </div>
              </details>
              <details>
                <summary>Warum lassen hartes Wasser und Chlor Haar stumpf und spröde wirken?</summary>
                <div className="ans">
                  Chlor und Kalk lagern sich aufs Haar und rauen die Oberfläche auf. Licht wird dann schlechter
                  reflektiert, das Haar wirkt matt, fühlt sich strohig an und bricht leichter, besonders bei hartem
                  Wasser.
                </div>
              </details>
              <details>
              ...
              <details>
                <summary>Ersetzt das meine Haarpflege oder Spülung?</summary>
                <div className="ans">
                  Nein. Pflege, Spülung und Kur bleiben wichtig. Ein Filterduschkopf ist eine sinnvolle Ergänzung für
                  schonenderes Wasser, kein Ersatz für deine Haarroutine.
                </div>
              </details>
              <details>
          ...
          <section style={{ paddingTop: 0 }} id="transparenz">
            <div className="wrap narrow">
              <div className="disclosure">
                ...
                <p>
                  Aussagen zu Glanz und Geschmeidigkeit beziehen sich auf schonenderes, gefiltertes Duschwasser und
                  können je nach Haar, Pflege und Wasserqualität variieren. Es handelt sich nicht um ein
                  Gesundheits- oder Wirkversprechen.
                </p>
                <p>
